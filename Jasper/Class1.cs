    ...
    public class Patch
    {
        ...
        public override string ToString()
        {
            ...
            foreach (Diff aDiff in this.diffs)
            {
                ...
                text.Append(System.Net.HttpUtility.UrlEncode(aDiff.text).Replace('+', ' ')).Append("\n");
            }
    ...
    public class diff_match_patch
    {
        ...
        public string diff_toDelta(List<Diff> diffs)
        {
            ...
            foreach (Diff aDiff in diffs)
            {
                ...
                {
                    case Operation.INSERT:
                        text.Append("+").Append(System.Net.HttpUtility.UrlEncode(aDiff.text).Replace('+', ' ')).Append("\t");
                        break;
                    case Operation.DELETE:
            ...
            foreach (string token in tokens)
            {
                ...
                switch (token[0])
                {
                    case '+':
                        ...
                        param = System.Net.HttpUtility.UrlDecode(param);
        ...
        public List<Patch> patch_fromText(string textline)
        {
            ...
            while (textPointer < text.Length)
            {
                ...
                while (textPointer < text.Length)
                {
                    ...
                    line = System.Net.HttpUtility.UrlDecode(line);
                    if (sign == '-')
                    {
                        // Deletion.
